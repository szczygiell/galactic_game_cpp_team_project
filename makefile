...
tests.o: tests.cpp Player.h Person.h Enemy.h Item.h Chest.h Action.h Gameplay.h Chest.h
	g++ -c tests.cpp
...
clean:
	rm -f tests.o* Player.o Person.o Item.o Gameplay.o tests.exe Chest.o
